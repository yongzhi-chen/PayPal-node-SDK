...
module.exports = {
  ...
  RefreshTokenRequest: require('./core/refresh_token_request').RefreshTokenRequest,
  TokenCache: require('./core/token_cache').TokenCache,
  UserConsent: require('./identity/userConsent').UserConsent,
  ...
  OrdersCancelRequest: require('./orders/ordersCancelRequest').OrdersCancelRequest,
  OrdersCreateRequest: require('./orders/ordersCreateRequest').OrdersCreateRequest,
  OrdersGetRequest: require('./orders/ordersGetRequest').OrdersGetRequest,
  OrdersPayRequest: require('./orders/ordersPayRequest').OrdersPayRequest,
