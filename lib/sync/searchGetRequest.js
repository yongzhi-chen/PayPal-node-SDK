// This class was generated on Fri, 26 Jan 2018 19:58:21 CST by version 0.1.0-dev+47ed6e of Braintree SDK Generator
// searchGetRequest.js
...
class SearchGetRequest {
  ...
  constructor() {
    this.path = '/v1/reporting/transactions?';
    this.verb = 'GET';
    this.body = null;
    this.headers = {
  ...
  balanceAffectingRecordsOnly(balanceAffectingRecordsOnly) {
    let params = querystring.escape(balanceAffectingRecordsOnly);

    this.path += 'balance_affecting_records_only=' + params + '&';
    return this;
  }
  ...
  paymentInstrumentType(paymentInstrumentType) {
    let params = querystring.escape(paymentInstrumentType);

    this.path += 'payment_instrument_type=' + params + '&';
    return this;
  }
  ...
  storeId(storeId) {
    let params = querystring.escape(storeId);

    this.path += 'store_id=' + params + '&';
    return this;
  }

  terminalId(terminalId) {
    let params = querystring.escape(terminalId);

    this.path += 'terminal_id=' + params + '&';
    return this;
  }

  transactionAmount(transactionAmount) {
    let params = querystring.escape(transactionAmount);

    this.path += 'transaction_amount=' + params + '&';
    return this;
  }

  transactionCurrency(transactionCurrency) {
    let params = querystring.escape(transactionCurrency);

    this.path += 'transaction_currency=' + params + '&';
    return this;
  }
  ...
  transactionStatus(transactionStatus) {
    let params = querystring.escape(transactionStatus);

    this.path += 'transaction_status=' + params + '&';
    return this;
  }

  transactionType(transactionType) {
    let params = querystring.escape(transactionType);

    this.path += 'transaction_type=' + params + '&';
    return this;
  }
}

module.exports = {SearchGetRequest: SearchGetRequest};
