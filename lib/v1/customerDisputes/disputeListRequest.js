...
class DisputeListRequest {
  ...
  constructor() {
    this.path = '/v1/customer/disputes?';
    this.verb = 'GET';
    this.body = null;
    this.headers = {
  ...
  disputeState(disputeState) {
    let params = querystring.escape(disputeState);

    this.path += 'dispute_state=' + params + '&';
    return this;
  }

  disputedTransactionId(disputedTransactionId) {
    let params = querystring.escape(disputedTransactionId);

    this.path += 'disputed_transaction_id=' + params + '&';
    return this;
  }

  nextPageToken(nextPageToken) {
    let params = querystring.escape(nextPageToken);

    this.path += 'next_page_token=' + params + '&';
    return this;
  }
...
module.exports = {DisputeListRequest: DisputeListRequest};
